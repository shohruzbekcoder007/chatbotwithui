...
class ChromaDBVisualizer:
    ...
    def get_embeddings_and_texts(self) -> Tuple[np.ndarray, List[str], List[Dict]]:
        ...
        Returns:
            embeddings: Embedding vektorlari (numpy array)
    ...
    def visualize_query_results(self, query: str, limit: int = 5, method: str = 'tsne',
        ...
        try:
            ...
            # So'rov embeddingi
            query_embedding = self.chroma_manager.embeddings.embed_query(query)
            
            # Natijalar embeddinglarini olish
            result_embeddings = self.chroma_manager.embeddings.embed_documents(results)

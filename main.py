...
# from models.langchain_vllmCustom import model as model_llm
# from models.langchain_huggingfaceCustom import model as model_llm
...
async def chat(request: Request, chat_request: ChatRequest):
    try:
        ...
        # response = await model_llm.chat(context, chat_request.query)
        # print(response, "<-")
